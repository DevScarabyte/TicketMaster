...
function MangLinkifier_SetItemRef(link, text, button)
  ...
  if ( strsub(link, 1, 9) == "targidadd" ) then
    SendChatMessage(".gobject add "..strsub(link, 11), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 10) == "targidlist" ) then
    SendChatMessage(".list object "..strsub(link, 12), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 10) == "targguidgo" ) then
    SendChatMessage(".go object "..strsub(link, 12), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 12) == "targguidmove" ) then
    SendChatMessage(".gobject move "..strsub(link, 14), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 12) == "targguidturn" ) then
    SendChatMessage(".gobject turn "..strsub(link, 14), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 11) == "targguiddel" ) then
    SendChatMessage(".gobject delete "..strsub(link, 13), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 7) == "targxyz" ) then
    SendChatMessage(".go "..strsub(link, 9), chanvar, nil, nil)
    return;
  ----------====~~ NPC Info Command Functions ~~====----------
  elseif ( strsub(link, 1, 9) == "npcguidgo" ) then
    SendChatMessage(".go creature "..strsub(link, 11), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 11) == "npcguidmove" ) then
    SendChatMessage(".go creature "..strsub(link, 13), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 11) == "npcentryadd" ) then
    SendChatMessage(".npc add "..strsub(link, 13), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 12) == "npcentrylist" ) then
    SendChatMessage(".list creature "..strsub(link, 14), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 10) == "npcdisplay" ) then
    SendChatMessage(".modify morph "..strsub(link, 12), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 11) == "npcdisplay2" ) then
    SendChatMessage(".modify morph "..strsub(link, 13), chanvar, nil, nil)
    return;
  ----------====~~ ADD GO Command Functions ~~====----------
  elseif ( strsub(link, 1, 11) == "addgoguidgo" ) then
    SendChatMessage(".go object "..strsub(link, 13), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 13) == "addgoguidmove" ) then
    SendChatMessage(".gobject move "..strsub(link, 15), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 13) == "addgoguidturn" ) then
    SendChatMessage(".gobject turn "..strsub(link, 15), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 12) == "addgoguiddel" ) then
    SendChatMessage(".gobject delete "..strsub(link, 14), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 7) == "addgoid" ) then
    SendChatMessage(".gobject add "..strsub(link, 9), chanvar, nil, nil)
    return;
  elseif ( strsub(link, 1, 8) == "addgoxyz" ) then
    SendChatMessage(".go "..strsub(link, 10), chanvar, nil, nil)
    return;
  ----------====~~ GPS Command Functions ~~====----------
  elseif ( strsub(link, 1, 6) == "gpsxyz" ) then
    SendChatMessage(".go  "..strsub(link, 8), chanvar, nil, nil)
    return;
  ----------====~~ Support for Clickable Links Made by Mangos and Added Options ~~====----------
  --elseif ( strsub(link, 1, 5) == "quest" ) then
    --SendChatMessage(".quest add "..strsub(link, 7), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 14) == "lookupquestadd" ) then
    --SendChatMessage(".quest add "..strsub(link, 16), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 14) == "lookupquestrem" ) then
    --SendChatMessage(".quest remove "..strsub(link, 16), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 13) == "lookupitemadd" ) then
    --SendChatMessage(".additem "..strsub(link, 15), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 14) == "lookupitemlist" ) then
    --SendChatMessage(".list item "..strsub(link, 16), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 16) == "gameobject_entry" ) then
    --SendChatMessage(".gobject add "..strsub(link, 18), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 11) == "lookupgoadd" ) then
    --SendChatMessage(".gobject add "..strsub(link, 13), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 12) == "lookupgolist" ) then
    --SendChatMessage(".list object "..strsub(link, 14), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 14) == "creature_entry" ) then
    --SendChatMessage(".npc add "..strsub(link, 16), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 17) == "lookupcreatureadd" ) then
    --SendChatMessage(".npc add "..strsub(link, 19), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 18) == "lookupcreaturelist" ) then
    --SendChatMessage(".list creature "..strsub(link, 20), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 10) == "gameobject" ) then
    --SendChatMessage(".go object "..strsub(link, 12), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 8) == "creature" ) then
    --SendChatMessage(".go creature "..strsub(link, 10), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 5) == "spell" ) then
    --SendChatMessage(".learn "..strsub(link, 7), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 16) == "lookupspelllearn" ) then
    --SendChatMessage(".learn "..strsub(link, 18), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 18) == "lookupspellunlearn" ) then
    --SendChatMessage(".unlearn "..strsub(link, 20), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 4) == "tele" ) then
    --SendChatMessage(".tele "..strsub(link, 6), chanvar, nil, nil)
    --return;
  --elseif ( strsub(link, 1, 16) == "lookupteledelete" ) then
    --SendChatMessage(".tele del "..strsub(link, 18), chanvar, nil, nil)
    --return;
  end
