...
function ReturnStrings_itIT()
  return {
    ["ma_GmatchRevision"] = "Versione di TrinityCore : (%d+)",
    ["ma_GmatchGPS"] = "X: (.*) Y: (.*) Z",
    ["ma_GmatchItem"] = "%|cffffffff%|Hitem:(%d+).*%[(.*)%]%|h%|r",
    ["ma_GmatchQuest"] = ".-(%d+).*%[(.*)%]%|h%|r",
    ["ma_GmatchItemSet"] = "|cffffffff|Hitemset:(%d+)|h%[(.-)%]|h|r",
    ...
    ["ma_GmatchGameObject"] = "|cffffffff|Hgameobject_entry:(%d+)|h%[(.-)%]|h|r",
    ["ma_GmatchTele"] = "%|cffffffff%|Htele:(.*)%|h%[(.*)%]%|h%|r",
    ["ma_GmatchTeleFound"] = "I luoghi trovati sono:",
    ["ma_GmatchUpdateDiff"] = "Distanza tra gli update: (.*)",
    ["ma_GmatchNewTicket"] = "Nuovo ticket da(.+)",
    ["ma_GmatchTicketsFull"] = "Messaggio del ticket.-:.-(.*)",
    ["ma_GmatchTickets"] = ".+Ticket.-:(.*)Creato da.-:|cff00ccff (.*)|r.+Creato.-:(.*)Ultima modifica.-:(.*)",
    ["ma_GmatchAccountInfo"] = "Player(.*) %(guid: (%d+)%) Account: (.*) %(id: (%d+)%) Email: (.*) GMLevel: (%d+) Ultimo IP: (.*) Ultimo login: (.*) Latenza: (%d+)ms",
    ["ma_GmatchAccountInfo2"] = "Razza: (.*) Classe: (.*) Tempo Giocato: (.*) Livello: (%d+) Denaro: (.*)",
    ["ma_GmatchOnlinePlayers"] = "Giocatori in linea: (%d+) %(max: (%d+)%)",
    ["ma_GmatchUptime"] = "Server up da: (.*)",
    ["ma_GmatchActiveConnections"] = "Connessioni Attive.*",
    ["ma_GmatchWho"] = "%-%[(.*)%]%[(.*)%]%[(.*)%]%[(.*)%]%[(.*)%]%[(.*)%]%[(.*)%]-",
    ...
    ["lfer_NPCInfoentry2"] = "Entry: (%d+)%.",
    ["lfer_NPCInfoentry3"] = "Entry: %1.",
    ["lfer_NPCInfodisplay1"] = "ID Visualizzato: (%d+)",
    ["lfer_NPCInfodisplay2"] = "ID Visualizzato: (%d+)",
    ["lfer_NPCInfodisplay3"] = "ID Visualizzato: %1.",
    ["lfer_NPCInfodisplay21"] = "%(Nativo: (%d+)%)",
    ["lfer_NPCInfodisplay22"] = "%(Nativo: (%d+)%)",
    ["lfer_NPCInfodisplay23"] = "(Nativo: (%1))",
    ----------====~~ ADD GO Command Match Text ~~====----------
    ["lfer_AddGoguid1"] = "%) %(GUID: (%d+)%)",
    ["lfer_AddGoguid2"] = "%(GUID: (%d+)%)",
    ["lfer_AddGoguid3"] = "(GUID: %1)",
    ["lfer_AddGoid1"] = "Oggetto '(%d+)'",
    ["lfer_AddGoid2"] = "Oggetto '(%d+)'",
    ["lfer_AddGoid3"] = "Oggetto '%1')",
    ["lfer_AddGoxyz1"] = "'([%p%d.%d]+) ([%p%d.%d]+) ([%p%d.%d]+)'",
    ["lfer_AddGoxyz2"] = "'([%p%d.%d]+) ([%p%d.%d]+) ([%p%d.%d]+)'",
    ["lfer_AddGoxyz3"] = "'%1 %2 %3'",
    ----------====~~ GPS Command Match Text ~~====----------
